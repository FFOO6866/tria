# ==========================================================================
# Tria AI-BPO AWS Infrastructure
# ECS/Fargate deployment with RDS PostgreSQL and ElastiCache Redis
# ==========================================================================
...
terraform {
  ...
  # backend "s3" {
  #   bucket         = "tria-aibpo-terraform-state"
  #   key            = "production/terraform.tfstate"
  #   region         = "us-east-1"
  #   encrypt        = true
  #   dynamodb_table = "tria-aibpo-terraform-locks"
  # }
}
...
resource "aws_elasticache_replication_group" "redis" {
  ...
  replication_group_description = "Redis cache for Tria AI-BPO"
  ...
  transit_encryption_enabled = false  # Set to true if needed, requires auth token
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "DATABASE_URL"
          value = "postgresql://${var.db_username}:${var.db_password}@${aws_db_instance.postgres.endpoint}/triadb"
        },
        {
          name  = "REDIS_HOST"
      ...
      secrets = [
        ...
        {
          name      = "SECRET_KEY"
          valueFrom = "arn:aws:secretsmanager:${var.aws_region}:${data.aws_caller_identity.current.account_id}:secret:${var.project_name}/${var.environment}/secret-key"
        }
      ]
